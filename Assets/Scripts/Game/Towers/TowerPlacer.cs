...
//     protected Character character = CharacterManager.instance.GetLocalPlayer();
...
//         float distance = Vector3.Distance(character.transform.position, cellworldPosition);
